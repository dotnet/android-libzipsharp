...
set LINKER_PARAMS="/PROFILE /DYNAMICBASE /CETCOMPAT /guard:cf"
set LINKER_PARAMS_ARM64="/PROFILE /DYNAMICBASE /guard:cf"
...
cmake %COMMON_CMAKE_PARAMS% ^
	...
	"-DCMAKE_EXE_LINKER_FLAGS_INIT=%LINKER_PARAMS%" ^
	-A x64 .
...
cmake %COMMON_CMAKE_PARAMS% ^
	...
	"-DCMAKE_EXE_LINKER_FLAGS_INIT=%LINKER_PARAMS_ARM64%" ^
	-A arm64 .
